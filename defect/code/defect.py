...
from transformers import (AdamW, get_linear_schedule_with_warmup,
                          ...
                          BartConfig,
                          BartTokenizer, T5Tokenizer, BertModel, T5ForConditionalGeneration,
...
def main():
    ...
    parser.add_argument('--adapter_name', type=str, default='defect_adapter', help="Adapter name for each layer.")
