...
def calculate_scores(answers, predictions):
    ...
    scores = {'F1': f1_score(y_trues, y_preds), 'Recall': recall_score(y_trues, y_preds),
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description='Evaluate leaderboard predictions for BigCloneBench data.')
